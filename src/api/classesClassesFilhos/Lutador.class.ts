...
export class Lutador extends Classes {
  ...
  private preencherNiveis() {
    return [
      { nivel: 1, proeficiencia: 2, caracteristicas: ["Estilo de Luta", "Retomar o Fôlego"] },
      ...
      { nivel: 5, proeficiencia: 3, caracteristicas: ["Ataque Extra"] },
      ...
      { nivel: 11, proeficiencia: 4, caracteristicas: ["Ataque Extra (2)"] },
      ...
      { nivel: 20, proeficiencia: 6, caracteristicas: ["Ataque Extra (3)"] }
    ];
  }
}