...
export class LaminaMaldita extends SubClasses {
    niveis: {
        nome: string;
        nivel: number;
        descricao: string;
    ...
    constructor() {
        super(
            "Lamina Maldita",
            "A característica Pacto da Lâmina, esse benefício se estende a todas as armas de pacto que conjure com essa característica, independente do tipo da arma."
        );
