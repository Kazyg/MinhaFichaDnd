export const caracteristicasDeClasse = [
  {
    nome: "Fúria",
    descricao: `
  ...
  },
  {
    ...
    descricao: `
        A partir do 2° nível, você pode desistir de toda preocupação com sua defesa para atacar com um desespero feroz. Quando você fizer o seu primeiro ataque no turno, você pode decidir atacar descuidadamente.
        Fazer isso lhe concede vantagem nas jogadas de ataque com armas corpo-a-corpo usando Força durante seu turno, porém, as jogadas de ataques feitas contra você possuem vantagem até o início do seu próximo turno.
      `,
  },
  {
  ...
  },
  {
    ...
    descricao: `
          ...
          Além disso, quando você realiza a ação de Ataque, você pode renunciar a um dos seus ataques para permitir que seu familiar realize um ataque, com a reação dele.
          Pacto da Lâmina
  ...
  },
  {
    ...
    descricao: `
          ...
          **Tabela Destruir Mortos-Vivos:**
          - 5° nível: Destrói Mortos-Vivos de ND 1/2 ou menor
          - 8° nível: Destrói Mortos-Vivos de ND 1 ou menor
          - 11° nível: Destrói Mortos-Vivos de ND 2 ou menor
          - 14° nível: Destrói Mortos-Vivos de ND 3 ou menor
          - 17° nível: Destrói Mortos-Vivos de ND 4 ou menor
        `,
  },
  {
  ...
  },
  {
    ...
    descricao: `
          ...
          **Formas de Besta:**
          - 2° nível: ND 1/4, sem deslocamento de voo ou natação (Exemplo: Lobo)
          - 4° nível: ND 1/2, sem deslocamento de voo (Exemplo: Crocodilo)
          - 8° nível: ND 1, sem limitações (Exemplo: Águia gigante)
  ...
  },
  {
    ...
    descricao: `
          ...
          **Espaços de Magia:**
          A tabela O Feiticeiro mostra quantos espaços de magia de 1° nível e superiores você possui disponíveis para conjuração. Para conjurar uma dessas magias, você deve gastar um espaço de magia do nível da magia ou superior. Você recupera todos os espaços de magia gastos quando você completa um descanso longo.
  ...
  },
  {
    ...
    descricao: `
          ...
          **Criando Espaços de Magia:**
          Você pode transformar pontos de feitiçaria disponíveis em um espaço de magia, com uma ação bônus, no seu turno. A tabela Criando Espaços de Magia mostra o custo para criar um espaço de magia de determinado nível. Você não pode criar espaços de magia acima do 5° nível.
      
          **Tabela Criando Espaços de Magia:**
          - 1° nível: Custo de 2 pontos de feitiçaria
          - 2° nível: Custo de 3 pontos de feitiçaria
          - 3° nível: Custo de 5 pontos de feitiçaria
          - 4° nível: Custo de 6 pontos de feitiçaria
          - 5° nível: Custo de 7 pontos de feitiçaria
  ...
  {
    nome: "Incremento Valor de Habilidade:",
    descricao: `
          Quando você atinge o 4° nível e novamente no 8°, 12°, 16° e 19° nível, você pode aumentar um valor de habilidade, à sua escolha, em 2 ou você pode aumentar dois valores de habilidade, à sua escolha, em 1. Como padrão, você não pode elevar um valor de habilidade acima de 20 com essa característica.
        `},
  {
  ...
  },
  {
    ...
    descricao: `
              No 3º nível, você escolhe um arquétipo que se esforçará para se equiparar através de exercícios de suas habilidades de ladino: Assassino, Ladrão ou Trapaceiro Arcano, todos detalhados no final da descrição da classe. Sua escolha garante a você características no 3º nível e de novo no 9º, 13º e 17º nível.
            `,
  },
  {
  ...
  },
  {
    ...
    descricao: `
              ...
              Quando o fizer, você não poderá fazê-lo de novo antes de terminar um descanso curto ou longo.
  ...
  },
  {
    ...
    descricao: `
              ...
              Quando você gasta um ponto de chi, ele se torna indisponível até você terminar um descanso curto ou longo, no fim deste, todos os pontos de chi gastos voltam para você. Você deve gastar, pelo menos, 30 minutos do descanso meditando para recuperar seus pontos de chi.
              Algumas das características de chi requerem que seu alvo realize um teste de resistência para resistir ao efeito da característica. A CD do teste de resistência é calculada da seguinte forma:
  ...
  },
  {
    ...
    descricao: `
              ...
              Além disso, você pode sintonizar seus sentidos para determinar se algum dos seus inimigos favoritos está espreitando nas redondezas. Ao passar 1 minuto ininterrupto em concentração (como se estivesse se concentrando em uma magia), você pode sentir se algum dos seus inimigos favoritos está presente a até 8 quilômetros de você. Essa característica revela qual dos seus inimigos favoritos está presente, a quantidade deles e a direção e distância aproximadas dessas criaturas (em quilômetros) de você.
  ...
  },
  {
    ...
    descricao: `
              ...
              Uma vez em cada um dos seus turnos, você pode adicionar seu modificador de Sabedoria na jogada de ataque ou jogada de dano de um ataque que você fizer.
  ...
  },
  {
    ...
    descricao: "O seu patrono permite que você escolha magias de uma lista expandida quando você for aprender magias de bruxo. As seguintes magias são adicionadas a sua lista de magias de bruxo."
  },
  {
